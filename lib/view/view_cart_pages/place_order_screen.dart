                  ...
                  decoration: BoxDecoration(
                    ...
                    Container(
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              for(int b = 0;  b < getCartController.getCartDetails.length ; b ++){
                                createOrderController.addCreateOrder(
                                  product_id:getCartController.getCartDetails[b].productId, 
                                  quantity: getCartController.getCartDetails[b].quantity, 
                                  amount: getCartController.getCartDetails[b].product.price, 
                                  payment_method_id: "1", 
                                  address_id: "1", 
                                  payment_status: "",
                                  cart_id: getCartController.getCartDetails[b].id.toString()
                                  );
                              }
                                  setDefault();
                            },
