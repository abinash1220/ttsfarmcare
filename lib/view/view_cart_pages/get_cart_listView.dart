                                              ...
                                              Icon(Icons.currency_rupee),
                                               Container(
                                                  ...
                                                  child: FittedBox(
                                                    ...
                                                    child: Text(
                                                      "${ widget.getCartDetails[index].product.price}",
                                                      style: GoogleFonts.roboto(
                                                        fontSize: 18.sp,
                                                        color: Colors.black,
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                              onTap: () {
                                                                int q = int.parse(widget.getCartDetails[index].quantity);
                                                               int totalquantity = q-1;
                                                               setState(() {
                                                                 widget.getCartDetails[index].quantity = totalquantity.toString();
                                                               });
                                                                addQuantityController.addQuantyval(
                                                                  cart_id: widget.getCartDetails[index].id.toString(), 
                                                                quantity: totalquantity.toString());
                                                                getCartController.calculate(widget.getCartDetails);
                                                              },
                                                              child: Padding(
                                                                padding:
                                                                    const EdgeInsets
